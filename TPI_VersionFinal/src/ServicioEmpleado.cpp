...
void ServicioEmpleado::modificarContrasenia(int idEmpleado)
{
    ...
    if(strcmp(empleado.getContrasenia().c_str(), pass.c_str()) == 0)
    {
        do
        {
            system("cls");
            ...
            if(strcmp(pass.c_str(), pass2.c_str()) == 0)
            {
...
///Una funcion que reciba un array y retorne la cantidad de num impares
int ServicioEmpleado::retornarCantidadImpares(int vectNum[], int tam)
{
    int cont = 0;
